...
const TourDetails = () => {
    ...
    const { data: tour, loading, error } = useFatch(`${BASE_URL}/tours/${id}`)
                                ...
                                <div className="tour__content">
                                    ...
                                    <div className="tour__reviews mt-4">
                                        ...
                                        <Form onSubmit={submitHandler}>
                                            <div className="d-flex align-items-center gap-3 md-4 rating__group">
                                            ...
                                            <div className="review__input">
                                                <input type="text" ref={reviewMsgRef} name="" id="" placeholder="Share your thoughts" required />
